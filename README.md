...
[在线页面](https://learnprompt.github.io/ai-news-radar/) · [English](README.en.md) · [伯乐Skill](~/.claude/skills/ai-news-radar/README.md) · [信息源策略](docs/SOURCE_COVERAGE.md)
...
- `~/.claude/skills/ai-news-radar/README.md`
- `~/.claude/skills/ai-news-radar/SKILL.md`
